/**************************************************************************
 *     This file is part of the SBM23 project.
 *
 *     SBM23 is custom game code for a 1980 Bally Silverball Mania pinball
 *     machine, built on the Retro Pin Upgrade (RPU) framework by Dick Hamill.
 *     Copyright (C) Dick Hamill and contributors.
 *     Modifications Copyright (C) Frank Goeltl.
 *
 *     SBM23 is free software: you can redistribute it and/or modify
 *     it under the terms of the GNU General Public License as published by
 *     the Free Software Foundation, either version 3 of the License, or
 *     (at your option) any later version.
 *
 *     SBM23 is distributed in the hope that it will be useful,
...
#define MACHINE_STATE_ADJUST_TOURNAMENT_SCORING (MACHINE_STATE_TEST_DONE-5)
#define MACHINE_STATE_ADJUST_TILT_WARNING       (MACHINE_STATE_TEST_DONE-6)
#define MACHINE_STATE_ADJUST_AWARD_OVERRIDE     (MACHINE_STATE_TEST_DONE-7)
#define MACHINE_STATE_ADJUST_BALLS_OVERRIDE     (MACHINE_STATE_TEST_DONE-8)
#define MACHINE_STATE_ADJUST_SCROLLING_SCORES   (MACHINE_STATE_TEST_DONE-9)
#define MACHINE_STATE_ADJUST_EXTRA_BALL_AWARD   (MACHINE_STATE_TEST_DONE-10)
#define MACHINE_STATE_ADJUST_SPECIAL_AWARD      (MACHINE_STATE_TEST_DONE-11)
#define MACHINE_STATE_ADJUST_DIM_LEVEL          (MACHINE_STATE_TEST_DONE-12)
#define MACHINE_STATE_ADJUST_DONE               (MACHINE_STATE_TEST_DONE-13)
