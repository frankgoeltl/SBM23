...
<section style="max-width:880px;margin:0 auto;padding:72px 32px 48px;text-align:center;">
  ...
  <p style="font-family:'Source Serif 4',Georgia,serif;font-size:18px;line-height:1.6;color:#2D2D2D;max-width:640px;margin:0 auto 32px;">This site showcases the approach on a 1980 Bally <b>Silverball Mania</b> \u2014 but that\'s just one example. The same workflow applies to dozens of classic solid-state pinball machines. Here you can test three rulesets side-by-side: the factory original, the community-enhanced SBM23, and a fresh FRG ruleset designed here. Trigger switches, watch the scoring react \u2014 it\'s a rules sandbox, not a physics sim.</p>
...
<section style="max-width:880px;margin:0 auto;padding:72px 32px 48px;text-align:center;">
  ...
  <p style="font-family:'Source Serif 4',Georgia,serif;font-size:18px;line-height:1.6;color:#2D2D2D;max-width:640px;margin:0 auto 32px;">Diese Seite zeigt den Ansatz am Beispiel des 1980er Bally <b>Silverball Mania</b> \u2014 das ist aber nur ein Beispiel. Derselbe Workflow l\u00e4sst sich auf dutzende klassische Solid-State-Flipper anwenden. Hier kannst du drei Regels\u00e4tze direkt vergleichen: das werksseitige Original, das erweiterte SBM23 der Community und einen frischen FRG-Regelsatz, der hier entstanden ist. Schalter ausl\u00f6sen, Scoring live beobachten \u2014 eine Regel-Sandbox, kein Physik-Simulator.</p>
  <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
